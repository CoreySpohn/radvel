...
//   // const double fivepi_d_12 = 3.14159265358979323846264338327950288 * 5. /
//   12;
...
//   /
//   // 6; const double elevenpi_d_12 = 3.14159265358979323846264338327950288
//   * 11.
//   // / 12;
//
//   const double g2s_e = 0.2588190451025207623489 * e;
...
//  *   n       1       Lengths of E, sinE, cosE, M
//  *=================================================================*/
// void eccanom_orvara(double E[], double sinE[], double cosE[], const double
// M[],
...
double timetrans_to_timeperi_c(const double tc, const double per,
  ...
  tp = tc - per / two_pi * (ee - ecc * sin(ee));
  return tp;
}

// void meananom(double M[], const double t[], const double tp, const double
// per,
//               const int n) {
...
//   const double twopi = 6.28318530717958647692528676655900576;
//   const double pi_d_2 = 1.57079632679489661923132169163975144;
//   const double one_d_24 = 0.041666666666666666666666666666666666667; // 1. /
//   24; const double one_d_240 =
...
//         rv[i] += _K * (cosarg * (fac - 1.0) - sinarg * ratio * fac +
//         ecccosarg);
//       }
//     }
//   }
...
double logprob(const double t[], const double rv[], const double rv_err[],
  ...
  **********************/
  ...
  for (int i = 0; i < ntimes; ++i) {
    ...
    penalty += log(sqrt(two_pi * sum_sig_quad[i]));
    // Chi2
    // res2 = res[i] * res[i];
